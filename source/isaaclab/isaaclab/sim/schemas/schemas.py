...
def activate_contact_sensors(prim_path: str, threshold: float = 0.0, stage: Usd.Stage = None):
    ...
    while len(all_prims) > 0:
        ...
        # Keep traversing after a rigid body. Some imported articulations place child rigid bodies under the
        # base-link Xform, and stopping here would leave those links without contact reporting.
